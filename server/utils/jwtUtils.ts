...
/**
 * Clear the JWT blacklist (for testing purposes)
 * Only available in test environment
 */
export const clearJwtBlacklist = (): void => {
 ...
 *
 * NOTE: This function is primarily intended for test isolation.
 * In production, tokens should expire naturally or be removed via TTL.
 */
...
/**
 * Get blacklist size (for testing and monitoring)
 */
...
/**
 * Reset token blacklist for testing purposes
 * This function clears all blacklisted tokens and should only be used in test environments
 */
