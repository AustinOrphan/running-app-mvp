...
router.get('/events', requireAdmin, asyncAuthHandler(async (req: AuthRequest, res) => {
  try {
    const {
      userId,
      action,
...
router.get('/statistics', requireAdmin, asyncAuthHandler(async (req: AuthRequest, res) => {
  try {
...
router.get('/security-events', requireAdmin, asyncAuthHandler(async (req: AuthRequest, res) => {
  try {
...
router.get('/user/:userId', requireAdmin, asyncAuthHandler(async (req: AuthRequest, res) => {
  try {
...
if (process.env.NODE_ENV === 'development') {
  router.post('/test', requireAdmin, asyncAuthHandler(async (req: AuthRequest, res) => {
    try {
