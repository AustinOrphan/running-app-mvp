  ...
  const handleRunSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showToast(`🏃‍♂️ Run ${action}! ${runForm.distance}km in ${runForm.duration}min (${pace}/km)`, 'success')
        resetForm()
        fetchRuns(token)
      } else {
        const errorData = await response.json().catch(() => ({}))
              ...
              <form onSubmit={handleRunSubmit} className="run-form">
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    />
                    {formErrors.distance && <span className="error-text">{formErrors.distance}</span>}
                  </div>
                  <div className="form-group">
                ...
                <div className="form-actions">
                  ...
                  <button type="button" onClick={resetForm} className="secondary-btn" disabled={loading}>
                    Cancel
                  </button>
                </div>
              </form>
