...
import { WeeklyInsights } from '@shared/types';
import { formatDuration, formatPace, safeAverage } from '@shared/utils/formatters';
import styles from '@client/styles/components/Stats.module.css';
