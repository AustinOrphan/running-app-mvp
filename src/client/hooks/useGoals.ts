...
import { Goal, GoalProgress, CreateGoalData } from '@shared/types/goals';
import { MilestoneDetector, DeadlineDetector } from '@shared/utils/milestoneDetector';
import { logError } from '@shared/utils/clientLogger';
import { apiGet, apiPost, apiPut, apiDelete } from '@shared/utils/apiFetch';
