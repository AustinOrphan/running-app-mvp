...
import { platformUtils, getAdjustedTimeout } from '../utils/platformUtils';

const PROJECT_ROOT = path.resolve(__dirname, '../..');
const BACKEND_PORT = 3001;
const FRONTEND_PORT = 3000;
const STARTUP_TIMEOUT = getAdjustedTimeout(60000); // Adjusted for platform and CI
  ...
  it(
    ...
    async () => {
      return new Promise<void>((resolve, reject) => {
        ...
        backendProcess = spawn(platformUtils.getNpmCommand(), ['run', 'dev'], {
          cwd: PROJECT_ROOT,
          stdio: 'pipe',
          env: platformUtils.createTestEnvironment({
  ...
  it(
    ...
    async () => {
      return new Promise<void>((resolve, reject) => {
        ...
        frontendProcess = spawn(platformUtils.getNpmCommand(), ['run', 'dev:frontend'], {
          cwd: PROJECT_ROOT,
          stdio: 'pipe',
          env: platformUtils.createTestEnvironment(),
        });
