...
describe('Card Accessibility Tests', () => {
  describe('Basic Card Components', () => {
    ...
    it('Interactive Card has proper ARIA attributes', async () => {
      ...
      // Enhanced accessibility testing with keyboard focus
      await expectAccessible(container, {
        wcagLevel: 'AA',
  ...
  describe('Enhanced Accessibility Compliance', () => {
    it('Card meets WCAG AA compliance standards', async () => {
      const { container } = render(
        <Card variant='goal' completed={false}>
          <CardHeader>
            <CardIcon color='#10b981'>🏃</CardIcon>
    ...
    it('Form elements in cards are fully accessible', async () => {
      const { container } = render(
        <Card>
          <CardContent>
            <form>
    ...
    it('Navigation elements in cards meet accessibility standards', async () => {
      const { container } = render(
        <Card>
          <CardHeader>
            <nav aria-label='Card actions'>
              <CardActions>
                <IconButton variant='edit' onClick={() => {}} aria-label='Edit item'>
                  ✏️
                </IconButton>
                <IconButton variant='delete' onClick={() => {}} aria-label='Delete item'>
                  🗑️
                </IconButton>
              </CardActions>
            </nav>
      ...
      // Use specialized navigation accessibility testing
