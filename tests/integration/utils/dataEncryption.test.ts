  ...
  describe('DataEncryption class', () => {
    describe('initialization', () => {
      ...
      it('throws error in production without key', () => {
        ...
        expect(() => new DataEncryption()).toThrow('CRITICAL: DATA_ENCRYPTION_KEY environment variable must be set in production');
    ...
    describe('encryptFields and decryptFields', () => {
      ...
      it('encrypts non-string values by converting to JSON', () => {
        ...
        const encrypted = encryption.encryptFields(obj, ['numberField', 'booleanField', 'objectField']);
        const decrypted = encryption.decryptFields(encrypted, ['numberField', 'booleanField', 'objectField']);
