...
jest.mock('/Users/austinorphan/Library/Mobile Documents/com~apple~CloudDocs/src/running-app-mvp/server/utils/winstonLogger.ts', () => ({
  winstonLogger: {
...
describe('Request Logger Middleware', () => {
  ...
  describe('requestLogger', () => {
    it('logs incoming requests', async () => {
      ...
      expect(mockWinstonInfo).toHaveBeenCalledWith('Request received', expect.objectContaining({
  ...
  describe('errorLogger', () => {
    it('logs request errors', async () => {
      ...
      expect(mockWinstonError).toHaveBeenCalledWith('Request error', expect.objectContaining({
        requestId: 'test-request-id',
        method: 'GET',
        url: '/test-error',
        component: 'api',
