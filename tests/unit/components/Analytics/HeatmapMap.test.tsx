...
describe('HeatmapMap', () => {
  ...
  describe('Info Section', () => {
    ...
    it('displays info about number of areas', () => {
      ...
      expect(screen.getByText('Showing 2 areas where you have run')).toBeInTheDocument();
    ...
    it('updates area count based on features', () => {
      ...
      expect(screen.getByText('Showing 1 areas where you have run')).toBeInTheDocument();
    });
  });
