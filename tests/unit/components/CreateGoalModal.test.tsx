...
describe('CreateGoalModal', () => {
  ...
  describe('Period Selection', () => {
    ...
    it('updates end date when period changes', async () => {
      ...
      // Change to monthly
      fireEvent.change(periodSelect, { target: { value: GOAL_PERIODS.MONTHLY } });
  ...
  describe('Date Handling', () => {
    ...
    it('sets default start date to today', () => {
      ...
      // Use the mocked date instead of actual current date
      const today = MOCK_DATES.NOW_STRING;
  ...
  describe('Form Validation', () => {
    ...
    it('shows error when target value is negative', async () => {
      ...
      fireEvent.change(titleInput, { target: { value: 'Test Goal' } });
      fireEvent.change(targetValueInput, { target: { value: '-5' } });
    ...
    it('shows error when end date is before start date', async () => {
      ...
      fireEvent.change(titleInput, { target: { value: 'Test Goal' } });
      fireEvent.change(targetValueInput, { target: { value: '10' } });
  ...
  describe('Form Submission', () => {
    ...
    it('resets form after successful submission', async () => {
      ...
      fireEvent.change(targetValueInput, { target: { value: '25' } });
