...
describe('PersonalRecordsTable', () => {
  ...
  describe('Distance Formatting', () => {
    it('formats standard distances correctly', () => {
      const customRecords = [
        ...
        { distance: 21.1, bestTime: 6300, bestPace: 298, date: '2024-01-01T00:00:00Z', runId: 'run2' },
        { distance: 42.2, bestTime: 12600, bestPace: 298, date: '2024-01-01T00:00:00Z', runId: 'run3' }
      ];
    ...
    it('formats sub-kilometer distances correctly', () => {
      const subKRecords = [
        { distance: 0.4, bestTime: 120, bestPace: 300, date: '2024-01-01T00:00:00Z', runId: 'run1' }
      ];
  ...
  describe('Component Structure', () => {
    it('has correct CSS classes for styling', () => {
      const { container } = render(<PersonalRecordsTable records={mockPersonalRecords} loading={false} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('calculates latest record correctly', () => {
      const recordsWithDifferentDates = [
        ...
        { distance: 10, bestTime: 3000, bestPace: 300, date: '2024-06-15T00:00:00Z', runId: 'run2' },
