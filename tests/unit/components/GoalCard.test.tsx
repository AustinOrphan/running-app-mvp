...
import { mockGoals, mockGoalProgress, createMockGoal, createMockGoalProgress } from '../../fixtures/mockData';
...
vi.mock('../../../src/components/Goals/GoalProgressChart', () => ({
  GoalProgressChart: ({ goal, progress }: any) => (
    <div data-testid="goal-progress-chart" data-goal-id={goal.id} data-progress={JSON.stringify(progress)}>
...
describe('GoalCard', () => {
  ...
  describe('Progress Display', () => {
    ...
    it('formats different units correctly', () => {
      const testCases = [
        { unit: 'hours', current: 10.5, target: 20, expectedCurrent: '10.5h', expectedTarget: '20.0h' },
        { unit: 'minutes', current: 45.7, target: 60, expectedCurrent: '46min', expectedTarget: '60min' },
        { unit: 'runs', current: 8, target: 12, expectedCurrent: '8 runs', expectedTarget: '12 runs' }
      ];
  ...
  describe('Expand/Collapse Functionality', () => {
    ...
    it('toggles expanded state when expand button is clicked', async () => {
      ...
      render(<GoalCard goal={activeGoal} progress={progress} enableExpandedView={true} {...defaultProps} />);
    ...
    it('does not show expanded content when progress is not available', async () => {
      ...
      render(<GoalCard goal={activeGoal} progress={undefined} enableExpandedView={true} {...defaultProps} />);
  ...
  describe('Detailed Progress View', () => {
    it('displays progress statistics in detailed view', () => {
      ...
      render(<GoalCard goal={goal} progress={progress} showDetailedView={true} {...defaultProps} />);
