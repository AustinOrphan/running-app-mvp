...
export const mockTrainingPlans = [
  {
    ...
    description: 'Complete training program for half marathon',
    goal: 'HALF_MARATHON',
    targetRaceId: 'race-1',
    startDate: new Date('2024-06-01'),
  ...
  },
  {
    ...
    description: 'Improve 5K pace through speed work',
    goal: 'IMPROVE_5K',
    targetRaceId: null,
    startDate: new Date('2024-06-01'),
  ...
  },
  {
    ...
    userId: 'user-123',
    name: 'Couch to 5K',
    description: 'Build base fitness for first 5K',
    goal: 'FIRST_5K',
    targetRaceId: null,
    ...
    isActive: false,
    difficulty: 'beginner',
    weeklyMileageStart: 5,
    weeklyMileageTarget: 15,
...
export const mockWorkoutTemplates = [
  {
    ...
    type: 'easy',
    name: 'Easy Run',
    description: 'Relaxed pace for recovery',
    targetDistance: 5,
    targetDuration: 1800,
    targetPace: 360,
    intensity: 'easy',
    notes: 'Sunday easy run',
    isCompleted: false,
    completedRunId: null,
    createdAt: new Date('2024-06-01T00:00:00Z'),
  ...
  },
  {
    ...
    type: 'tempo',
    name: 'Tempo Run',
    description: 'Moderate-hard pace workout',
    targetDistance: 8,
    targetDuration: 2400,
    targetPace: 300,
    intensity: 'moderate',
    notes: 'Tuesday tempo work',
    isCompleted: true,
