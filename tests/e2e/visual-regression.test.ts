...
import { waitForChartRender, waitForAnimation } from './utils/wait-conditions';
...
test.describe('Visual Regression Tests', () => {
  ...
  test.describe('Dashboard Views', () => {
    ...
    test('should match dashboard loading state', async ({ page }) => {
      ...
      await page.reload();
      await waitForAnimation(page, 200); // Let loading spinners appear
  ...
  test.describe('Statistics Dashboard', () => {
    test.beforeEach(async ({ page }) => {
      ...
      // Wait for charts to render with optimized waiting
  ...
  test.describe('Error State Visual Tests', () => {
    ...
    test('should match network error state', async ({ page }) => {
      ...
      await page.reload();
      await waitForAnimation(page, 500); // Wait for error states to appear
