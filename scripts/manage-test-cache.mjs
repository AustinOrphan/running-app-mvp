...
function showCacheStats() {
  ...
  if (totalSize > 100 * 1024 * 1024) {
    // > 100MB
    console.log(
      '⚠️  Cache size is large. Consider running "npm run test:cache:clear" if tests are behaving unexpectedly.'
    );
  } else if (totalSize > 0) {
    console.log(
      '✅ Cache size is reasonable. Jest caching is active and should improve test performance.'
    );
  } else {
