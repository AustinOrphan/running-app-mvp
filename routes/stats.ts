...
router.get('/insights-summary', requireAuth, asyncAuthHandler(async (req: AuthRequest, res) => {
...
router.get('/type-breakdown', requireAuth, asyncAuthHandler(async (req: AuthRequest, res) => {
...
router.get('/trends', requireAuth, asyncAuthHandler(async (req: AuthRequest, res) => {
...
router.get('/personal-records', requireAuth, asyncAuthHandler(async (req: AuthRequest, res) => {
  const runs = await prisma.run.findMany({
    where: { userId: req.user!.id },
    orderBy: { date: 'desc' },
  });
